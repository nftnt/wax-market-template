...
import {getAuctions, getFirstapp, getWonAuctions} from "../api/Api";
...
const FirstApps = (props) => {
    ...
    const initAuctions = async (page) => {
        ...
        if (winner)
            ...
            getFirstapp(getFilters(values, state.collections, 'auctions', page)).then(result => getResult(result));
    };
    ...
    return (
        <Page onScroll={e => handleScroll(e)} id="AuctionPage">
            ...
            />
            <Content headline="First Appearance Auctions">
